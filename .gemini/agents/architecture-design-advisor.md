...
- **Monorepo structure**: Respect existing package boundaries (`apps/api`, `apps/web`, `packages/shared`, `packages/api-client`, `packages/ui`). New features go in the right package — don't sprawl.
