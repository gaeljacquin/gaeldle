...
import { useWishlistEpicStore } from '@/lib/stores/game-list-store';
...
export function WishlistEpicView() {
  const [isMultiSelect, setIsMultiSelect] = useState(false);
  const [selectedIds, setSelectedIds] = useState<Set<number>>(new Set());
  const [isDeleteDialogOpen, setIsDeleteDialogOpen] = useState(false);

  const store = useWishlistEpicStore();
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: ['wishlist-epic'] });
      ...
      <div className="flex flex-col min-h-full bg-background">
        ...
        >
          <GameListContent
            ...
            emptyMessage="Your Epic wishlist is currently empty."
          />
        </div>
      </div>
    </ViewTransition>
...
export default WishlistEpicView;
