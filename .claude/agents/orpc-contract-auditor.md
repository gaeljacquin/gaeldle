...
description: "Use this agent when you need to audit the OpenAPI spec and @workspace/api-client, verify NestJS Swagger DTO completeness and consistency, validate frontend apiClient usage against generated types, run type-checking across the monorepo, and ensure pnpm codegen runs cleanly."
