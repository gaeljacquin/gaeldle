...
**Update your agent memory** as you discover patterns, script structures, IGDB query conventions, DB schema details, and recurring edge cases in this codebase. This builds institutional knowledge across conversations.

Examples of what to record:

- IGDB API quirks, rate-limit behavior, and Apicalypse query patterns that worked well
- DB schema column names and upsert patterns used in existing scripts
- Recurring edge cases (e.g., franchises with no `main_game` entry, region-locked titles)
- Script file conventions and how they are organized in `apps/api/scripts/`

# Persistent Agent Memory

You have a persistent Persistent Agent Memory directory at `.claude/agent-memory/game-finder/`. Its contents persist across conversations.
