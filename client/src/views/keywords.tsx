          ...
          <div className="flex-grow container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                ...
                <p className="mb-4 font-md font-light">
                  1 keyword is revealed per attempt. All keywords are revealed
                  on the final attempt.
                </p>
                <p className="mb-4 font-md font-light">
                  Today&apos;s game has{" "}
                  <span className="font-bold">{numKeywords}</span> keywords
                </p>
                <div className="flex flex-wrap gap-3">
                  {keywords.map((keyword, index) => (
                    <span
                      key={keyword + "-" + index}
                      className="bg-gael-purple text-white px-4 py-2 rounded-full text-md"
                    >
                      {keyword}
                    </span>
                  ))}
