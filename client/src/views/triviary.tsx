          ...
          <div className="flex flex-col min-h-screen">
            ...
            >
              ...
              <div className="flex justify-center">
                <div className="flex flex-row px-4 py-8 rounded-lg bg-white shadow-sm border-dashed border-2 border-gray-600 overflow-x-auto">
                  {!(gameOver || won) && (
                    <div className="flex justify-start p-0 space-x-4">
                      <SortableContext
                        items={timeline.map((card) => card?.igdbId ?? 0)}
                        strategy={
                          correctIgdbs.length > 0
                            ? rectSwappingStrategy
                            : horizontalListSortingStrategy
                        }
                      >
                        {timeline.map((card: Partial<Game>, index) => (
                          <div key={card.igdbId}>
                            ...
                            <Badge
                              className={`flex items-center justify-center ${bgPartial} text-white text-xs font-semibold px-2 py-2 mt-4`}
                            >
                              {index + 1}
                            </Badge>
                          </div>
