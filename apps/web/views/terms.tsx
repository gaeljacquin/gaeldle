      ...
      <div className="max-w-4xl mx-auto p-8 space-y-6">
        ...
        <div className="space-y-6">
          ...
          <p className="text-base leading-7">
            ...
            the name of a game based on their cover image or related artwork
          ...
          <ul className="list-disc pl-6 space-y-2 text-base leading-7">
            <li>
              ...
              matters related to
              {appInfo.title} are protected under applicable copyrights and
            ...
            <li>
              ...
              appearing on the site are protected by copyright and trademark
              laws and are only to be viewed as part of gameplay on{' '}
              {appInfo.title}. Any reproduction, distribution, or use of these
            ...
            <li>
              ...
              [at] gaeljacquin [dot] com with details of the alleged
              infringement.
            </li>
          </ul>
