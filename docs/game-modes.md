...
- A correct placement adds the card to the timeline and reveals its date; an incorrect placement also adds the card at its correct position but costs an attempt
- The next card is then dealt and the process repeats
- You have **7 mistakes** before the game ends
- Your score is the number of cards you placed correctly
...
- A comparison grid shows how each of the eight specifications match the target game:
  ...
  - **Red** — no match
- The eight compared specifications are: Platforms, Genres, Themes, Release Year, Game Modes, Game Engines, Publisher, and Player Perspective
