...
import { currentYear } from '@/utils/client-constants';
...
export default function Footer(props: Props) {
  ...
  return (
    <>
      <footer className="bg-muted mt-auto"></footer>

      <footer
        role="contentinfo"
        className="bg-gradient-to-r from-blue-700 to-teal-600 text-white pt-8 pb-6"
      >
        <div className="container mx-auto px-4 py-6 justify-between items-center bg-gradient-to-r from-blue-700 to-teal-600 text-white">
              ...
              <div className="flex flex-wrap items-top mb-6">
                ...
                <div className="w-full md:w-3/12 px-4 mb-4 md:mb-0">
                  ...
                  <ul className="list-unstyled space-y-4">
                    {modes &&
                      modes.map((mode) => (
                        <li key={mode.id}>{navLink(`/${mode.mode}`, mode.label ?? '')}</li>
                      ))}
                  </ul>
                </div>
                <div className="w-full md:w-3/12 px-4 mb-4 md:mb-0">
                ...
                <div className="w-full md:w-3/12 px-4 mb-4 md:mb-0">
                  <span className="block text-lg font-semibold mb-2">Socials</span>
                  <ul className="list-unstyled space-y-4">
                    <li>{navLink('https://linkedin.com/in/gaeljacquin', 'LinkedIn', true)}</li>
                    <li>{navLink('https://github.com/gaeljacquin', 'GitHub', true)}</li>
                  </ul>
                </div>
              </div>
            </div>
