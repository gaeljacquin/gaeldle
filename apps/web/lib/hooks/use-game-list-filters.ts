...
export interface UseGameListFiltersOptions {
  store: GameListStore;
}
...
export function useGameListFilters({ store }: UseGameListFiltersOptions) {
...
export type UseGameListFiltersReturn = ReturnType<typeof useGameListFilters>;
